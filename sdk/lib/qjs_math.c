...
/* ---------------------------------------------------------------------------
 * Inverse trig — sdk/lib/math.c has fpatan-based atan2 and log10 already,
 * but no atan / asin / acos (the latter two were stubs returning 0).
 * Express everything in terms of the existing FPU-based atan2 for both
 * accuracy and brevity.
 * ------------------------------------------------------------------------ */

/* atan(x) = atan2(x, 1) — uses the x87 fpatan in sdk/lib/math.c. */
