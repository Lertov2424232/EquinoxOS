...
CFLAGS = -ffreestanding -O2 -Wall -Wextra \
           ...
           -fno-stack-protector -fno-pic -fno-threadsafe-statics -g
CPPFLAGS = -ffreestanding -O2 -Wall -Wextra -fno-exceptions -fno-rtti -std=c++17 \
           -Isrc -Isrc/drivers -Isrc/shell -Isrc/boot/limine \
           -mcmodel=kernel -mno-red-zone -mno-mmx -mno-sse -mno-sse2 \
           -fno-stack-protector -fno-pic -fno-threadsafe-statics -g
...
OBJ = $(OBJ_DIR)/kernel.o $(OBJ_DIR)/io.o $(OBJ_DIR)/keyboard.o $(OBJ_DIR)/rtl8139.o \
      ...
      $(OBJ_DIR)/pic.o $(OBJ_DIR)/interrupt.o $(OBJ_DIR)/timer.o $(OBJ_DIR)/ata.o $(OBJ_DIR)/bmp.o $(OBJ_DIR)/cpp_runtime.o \
